...
<div id="page">
	...
	<div id="bg">
			...
			<div class="post" style="padding-top: 57px;">								
						<video width="550" height="425" controls autoplay>
							...
							<object width="640" height="360" type="application/x-shockwave-flash" data="player.swf">
								...
								<param name="flashvars" value="autostart=true&amp;controlbar=over&amp;image=poster.jpg&amp;file=http://localhost/YouTune/snowglas/media/test.mp4" />
								<!-- fallback image -->
		...
		<div id="sidebar">
		<br />
		<button id="Search-Dialog"><span class="ui-icon ui-icon-search"></span>Administration</button>
			
			<div id="about-box">
				
				<h2>Our partners</h2>
				<p>This project was support by Crisp Software Labs</p>
				
				
<div id="Search-form" title="Administration">
